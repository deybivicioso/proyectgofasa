...
public class FORMU_CLIENTE_GOFASA implements ActionListener {
	...
	JMenuItem Empleados, analisis, Menu_aliniacion, Menu_tren, Menu_goma, Menu_aceite, mn_vehiculo, cliente;
	JComboBox comboBox;
	...
	private void initialize() {
		...
		cliente = new JMenuItem("Cliente"); /*
											 ...
											 * fue actializado por deybi vicioso 2022-0030
											 */
		cliente.addActionListener(this);
		MNregistro.add(cliente);
	...
	public void actionPerformed(ActionEvent e) {
		...
		}else if (e.getSource()==cliente) {     /*seccion actualizada por deybi viciosos 2022-0030 */
	    	Cliente C = new Cliente();
	    	C.frm_cliente_gofasa.setVisible(true);
	    }
	...
	public void actionbotones(ActionEvent e) {
		if (e.getSource() == btnañadir) {
			cabeza_fmkw.addRow(new Object[] { texnombre.getText(), textapellido.getText(), textreferencia.getText(),
					comboBox.getSelectedItem(), texttelefono.getText() });
			texnombre.setText("");
